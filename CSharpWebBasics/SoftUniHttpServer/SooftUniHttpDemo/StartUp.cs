...
public class StartUp
{
    ...
    {
        var hasRequestCookies = request.Cookies.Any(c => c.Name != Session.SessionCookieName);
        var bodyText = "";
    ...
    private static void LoginAction(Request request, Response response)
    {
        ...
        var passwirdMatches = request.Form["Password"] == StartUp.Password;

        if (usernameMatches && passwirdMatches)
        {
